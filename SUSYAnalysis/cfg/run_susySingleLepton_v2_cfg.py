...
#  from CMGTools.RootTools.samples.samples_13TeV_MiniAODv2_Signals_desy import *
  ...
  selectedComponents = [SMS_T1tttt_TuneCUETP8M1, SMS_T2bb_TuneCUETP8M1]#[T1tttt_mGo_1475to1500_mLSP_1to1250, T1tttt_mGo_1200_mLSP_1to825 ]
  if test==1:
    # test a single component, using a single thread.
...
if isSignal:
  ...
  #susyCounter.SMS_varying_masses = ['genSusyMSbottom','genSusyMNeutralino']
